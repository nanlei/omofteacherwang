...
<div class="wrapper col2">
  <div id="breadcrumb">
    <ul>
      ...
      <li>&#187;</li>
      <#if loginUser?exists>
      	<li class="last"><a href="${base}/front/Member!viewMethod.action">奥数方法认识</a></li>
      <#else>
      	<li class="last"><a href="${base}/front/Anonym!viewMethod.action">奥数方法认识</a></li>
      </#if>
    </ul>
  </div>
</div>
			...
			<#list methodMap.methodList.list as list>
       			<tbody>
          			<tr class="light">
            			...
            			<#if loginUser?exists>
            				<td><a href="${base}/front/Member!viewMethodDetail.action?id=${list.Id}" target="_black">查看</a></td>	
            			<#else>
