...
<div class="wrapper col2">
  <div id="breadcrumb">
    <ul>
      ...
      <li>&#187;</li>
      <li class="current"><a href="${base}/front/Anonym!viewExperience.action">奥数教育心得</a></li>
    </ul>
  </div>
</div>
<#-- /当前位置-->
      ...
      <div class="subnav">
        ...
        <#if experienceMap.experienceDivision?has_content>
			<#list experienceMap.experienceDivision as list>
          		<li><a href="${base}/front/Anonym!viewExperienceDivision.action?id=${list.id}">${list.name?default('-')?html}</a></li>
         	</#list>
  		</#if>
        </ul>
      </div>
