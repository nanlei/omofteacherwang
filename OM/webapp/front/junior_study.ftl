  ...
  <div id="header">
    ...
    <div id="topnav">
      ...
      <ul>
        ...
        <li class="active"><a href="${base}/front/<@p.nameSpace loginUser?exists />!viewJuniorStudy.action">初中段学习</a></li>
  ...
  <div id="breadcrumb">
    <ul>
      <li class="first">您的当前位置</li>
      	<li>&#187;</li>
      	<li class="last"><a href="${base}/front/<@p.nameSpace loginUser?exists />!viewJuniorStudy.action">初中学习咨询</a></li>
    </ul>
  </div>
</div>
<#-- /当前位置-->
