  ...
  <div id="header">
    ...
    <div id="topnav">
      <ul>
        ...
        <li  class="active"><a href="${base}/front/<@p.nameSpace loginUser?exists />!shareData.action">资料分享</a></li>
      </ul>
      <br class="clear" />
      <ul>
        ...
        <li><a href="${base}/front/<@p.nameSpace loginUser?exists />!aboutUs.action">关于我们</a></li>
      </ul>
    </div>
    <br class="clear" />
  </div>
