<@admin.page>
	<@adminApp.naviBar navi="系统管理,奥数资料分享,资料分类管理,首页" />
	<@adminApp.naviInfo helpInfoTitle="查看页面说明" helpInfoContent="这里是奥数资料分享分类管理页面，下面列出了奥数资料分享分类的信息，您可以维护这些信息<br>当分类中有资料时，您不能删除该分类">
