<@admin.page>
	<@adminApp.naviBar navi="系统管理,奥数资料分享,资料分类管理,修改,首页" />
	<@adminApp.naviInfo helpInfoTitle="查看页面说明" helpInfoContent="这里是奥数资料分享分类信息页面，您可以维护这些信息<br>">
	<a href="javascript:history.go(-1)" class="navlink">返回</a>
	</@adminApp.naviInfo>
<form name="dataForm" action="update.action?categoryId=${categoryMap.ID}" method="post" onsubmit="return validateForm(this)">
<table width="100%" class="default">
	<col width="40%" align="center">
	<col width="60%" align="center">
	<tr class="title">
		<td colspan="2">修改资料分享分类（带<@admin.mustMark/>的项是必填项）</td>
	</tr>
	<tr>
		<td>分类名称</td>
